...
proc sql noprint;
   select count(*) into :nobs from adsl_01;
quit;
...
column   page group c1  c2 intord c3 c4 c5  ;
...
*redacted;(prog=&prog_loc./dm010t.log);
*redacted;(prog=&prog_loc./dm010t.sas);
